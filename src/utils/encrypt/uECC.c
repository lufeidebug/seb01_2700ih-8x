...
void uEcc_160r1_mod(uint8_t *output, uint8_t *input)
{
    const struct uECC_Curve_t *curves = uECC_secp160r1();

    uECC_vli_mmod((uECC_word_t *)output, (uECC_word_t *)input, curves->n , curves->num_words+1);
}
   
void uEcc_160r1_mult(uint8_t    *output, uint8_t *input)
{
    const struct uECC_Curve_t *curves = uECC_secp160r1();

    EccPoint_compute_public_key((uECC_word_t *)output, (uECC_word_t *)input, curves);
