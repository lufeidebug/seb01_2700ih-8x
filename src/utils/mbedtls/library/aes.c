...
int mbedtls_aes_self_test( int verbose )
{
    ...
    for( i = 0; i < 6; i++ )
    {
        ...
        time[i] = FAST_TICKS_TO_US(hal_fast_sys_timer_get() - time_start);
    }

    if( verbose != 0 ){
        mbedtls_printf( "\n" );
        mbedtls_printf("ECB mode time cost: %uus %uus %uus %uus %uus %uus \n", time[0],time[1],time[2],time[3],time[4],time[5]);
    }
    ...
    if( verbose != 0 ){
        mbedtls_printf( "\n" );
        mbedtls_printf("CBC mode time cost: %uus %uus %uus %uus %uus %uus \n", time[0],time[1],time[2],time[3],time[4],time[5]);
    }
#endif /* MBEDTLS_CIPHER_MODE_CBC */
    ...
    if( verbose != 0 ){
        mbedtls_printf( "\n" );
        mbedtls_printf("CFB mode time cost: %uus %uus %uus %uus %uus %uus \n", time[0],time[1],time[2],time[3],time[4],time[5]);
    }
#endif /* MBEDTLS_CIPHER_MODE_CFB */
    ...
    if( verbose != 0 ){
        mbedtls_printf( "\n" );
        mbedtls_printf("OFB mode time cost: %uus %uus %uus %uus %uus %uus \n", time[0],time[1],time[2],time[3],time[4],time[5]);
    }
#endif /* MBEDTLS_CIPHER_MODE_OFB */
    ...
    if( verbose != 0 ){
        mbedtls_printf( "\n" );
        mbedtls_printf("CTR mode time cost: %uus %uus %uus %uus %uus %uus \n", time[0],time[1],time[2],time[3],time[4],time[5]);
    }
#endif /* MBEDTLS_CIPHER_MODE_CTR */
    ...
    if( verbose != 0 ){
        mbedtls_printf( "\n" );
        mbedtls_printf("ECB mode time cost: %uus %uus %uus %uus %uus %uus s\n", time[0],time[1],time[2],time[3],time[4],time[5]);
    }
