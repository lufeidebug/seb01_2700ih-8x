...
typedef struct os_timer_def_ex  {
  ...
  uint32_t           os_timer_cb[5];
} osTimerDefEx_t;

#define osTimerInit(pTimer,function)  \
((osTimerDefEx_t*)&pTimer)->os_timer_def.ptimer = function; \
((osTimerDefEx_t*)&pTimer)->os_timer_def.timer = ((osTimerDefEx_t*)&pTimer)->os_timer_cb; \
memset(((osTimerDefEx_t*)&pTimer)->os_timer_cb,0,5*sizeof(uint32_t))
...
((osMutexDefEx_t*)&pMutex)->os_mutex_def.mutex = ((osMutexDefEx_t*)&pMutex)->os_mutex_cb; \
memset(((osMutexDefEx_t*)&pMutex)->os_mutex_cb,0,3*sizeof(uint32_t))
...
uint32_t os_ticks_to_ms(uint32_t os_ticks);
