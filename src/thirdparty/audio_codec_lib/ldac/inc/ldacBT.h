...
enum LDAC_DECODER_CHANNEL_SELECT_E
{
    LDAC_DECODER_CHANNEL_SELECT_SELECT_STEREO ,
    LDAC_DECODER_CHANNEL_SELECT_SELECT_LRMERGE,
    LDAC_DECODER_CHANNEL_SELECT_LCHNL,
    LDAC_DECODER_CHANNEL_SELECT_RCHNL,
};

LDACBT_API int ldacBT_set_channel_sel(enum LDAC_DECODER_CHANNEL_SELECT_E sel);
