 ...
 * @return return value
 */
int32_t lhdcv5_util_init_decoder(void *ptr, uint32_t bitPerSample, uint32_t sampleRate, uint32_t audioFormat, uint32_t frm_duration, uint32_t lossless_enable, uint32_t is_lossless_raw_enable, lhdcv5_ver_t version);
