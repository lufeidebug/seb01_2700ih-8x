# -------------------------------------------
# BT host stack rom features
# -------------------------------------------
ifeq ($(BUILD_BTH_ROM),1)
KBUILD_CPPFLAGS += -DBUILD_BTH_ROM
endif
...
ifeq ($(filter -DBT_DEVICE_NUM%,$(KBUILD_CPPFLAGS)),)
export BT_DEVICE_NUM ?= 2
KBUILD_CPPFLAGS += -DBT_DEVICE_NUM=$(BT_DEVICE_NUM)
endif

ifeq ($(filter -DBTM_MAX_LINK_NUMS%,$(KBUILD_CPPFLAGS)),)
export BTM_MAX_LINK_NUMS := $(shell echo $$(($(BT_DEVICE_NUM) + 1)))
KBUILD_CPPFLAGS += -DBTM_MAX_LINK_NUMS=$(BTM_MAX_LINK_NUMS)
endif
...
export ENHANCED_TWS_UI_ENABLED ?= 1
...
KBUILD_CPPFLAGS += -DBLE_SEEMLESS_ENABLED=1
endif

ifeq ($(BLE_SEEMLESS_ENABLED)_$(BT_SVC_MODULE_TWS_ENABLED),0_1)
ifneq ($(BLE_AUDIO_ENABLED),1)
export BLE_ROLESWITCH_ENABLED := 1
KBUILD_CPPFLAGS += -DBLE_ROLESWITCH_ENABLED=1
endif
endif
...
export BLE_LEGACY_APP_ENABLED ?= $(BT_SVC_MODULE_TWS_ENABLED)
ifeq ($(BLE_LEGACY_APP_ENABLED),1)
KBUILD_CPPFLAGS += -DBLE_LEGACY_APP_ENABLED=1
endif

export LEA_CAPTURE_SUPPORT ?= 1
ifeq ($(LEA_CAPTURE_SUPPORT),1)
KBUILD_CPPFLAGS += -DLEA_CAPTURE_SUPPORT
endif
...
export CUSTOMER_ADAPTER_HM_SUPPORT ?= 0
ifeq ($(CUSTOMER_ADAPTER_HM_SUPPORT),1)
KBUILD_CPPFLAGS += -DCUSTOMER_ADAPTER_HM_SUPPORT
endif
...
BTHOST_LOGGER_HCI_LEVEL     ?= LOGGER_LEVEL_INFO
BTHOST_LOGGER_TEST_LEVEL    ?= LOGGER_LEVEL_INFO
BTHOST_LOGGER_STACK_LEVEL   ?= LOGGER_LEVEL_INFO
BTHOST_LOGGER_SERVICE_LEVEL ?= LOGGER_LEVEL_INFO
BTHOST_LOGGER_BTH_MID_LEVEL ?= LOGGER_LEVEL_DEBUG

KBUILD_CPPFLAGS += -DHCI_LEVEL=$(BTHOST_LOGGER_HCI_LEVEL)
KBUILD_CPPFLAGS += -DTEST_LEVEL=$(BTHOST_LOGGER_TEST_LEVEL)
KBUILD_CPPFLAGS += -DSTACK_LEVEL=$(BTHOST_LOGGER_STACK_LEVEL)
KBUILD_CPPFLAGS += -DSERVICE_LEVEL=$(BTHOST_LOGGER_SERVICE_LEVEL)
KBUILD_CPPFLAGS += -DBTH_MID_LEVEL=$(BTHOST_LOGGER_BTH_MID_LEVEL)
