...
#define REG_PPG_TH_SEL          0xB1
#define REG_DDAC_CO_FI_SEL      0xA3
#define REG_PROX_STATE_MODE     0x03
#define REG_PROX_DIGITAL_GAIN   0xB6
#define REG_PROX_FILTER_SET     0x2F        
