...
const unsigned char g_ss_ppg_init_register_ssh202[][2] = {
    ...
    {REG_SEQ0_H_TIA_GAIN, 0x33},      // TIA Gain=50Kohm (x8)
    {REG_SEQ0_H_INT_GAIN, 0x44},      // INT Gain=100Kohm/8pF
};
...
const unsigned char g_ss_ppg_init_register_ssh401[][2] = {
    ...
    // Gen2 initial configuration for Proximity mode and PPG mode.
    // Sensor operating modes and behavior are controlled through the REG_MEASUREMENT register.
