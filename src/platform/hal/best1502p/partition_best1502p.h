...
#ifndef PARTITION_BEST1502P_H
#define PARTITION_BEST1502P_H
...
*/
#define SAU_INIT_START0     (RAMX0_BASE+RAM_S_SIZE) //0x00218000

/*
//     <o>End Address <0x1F-0xFFFFFFFF>
*/
//#define SAU_INIT_END0       (FLASHX_BASE-1) //0x0BFFFFFF
#define SAU_INIT_END0       (RAMX0_BASE+RAM_S_SIZE+RAM_NSC_SIZE-1) //0x0401ffff
...
//     <o>Start Address <0-0xFFFFFFE0>
*/
#define SAU_INIT_START1     (RAMX0_BASE+RAM_S_SIZE+RAM_NSC_SIZE)

/*
//     <o>End Address <0x1F-0xFFFFFFFF>
*/
#define SAU_INIT_END1       (RAM_NS_TO_S(ROMX_BASE)-1)
...
//     <o>Start Address <0-0xFFFFFFE0>
*/
#define SAU_INIT_START2     (FLASHX_BASE+FLASH_S_SIZE) //0x0C040000

/*
//     <o>End Address <0x1F-0xFFFFFFFF>
*/
#define SAU_INIT_END2       (RAM0_BASE-1) //0x1FFFFFFF
...
//     <o>Start Address <0-0xFFFFFFE0>
*/
#define SAU_INIT_START3     (RAM0_BASE+RAM_S_SIZE+RAM_NSC_SIZE) //0x20018000

/*
//     <o>End Address <0x1F-0xFFFFFFFF>
*/
#define SAU_INIT_END3       0xFFFFFFFF
...
//     <o>Start Address <0-0xFFFFFFE0>
*/
#define SAU_INIT_START4     (RAM_NS_TO_S(ROMX_BASE + ROM_SIZE))      /* start address of SAU region 4 */

/*
//     <o>End Address <0x1F-0xFFFFFFFF>
*/
#define SAU_INIT_END4       (FLASHX_BASE-1) //0x0BFFFFFF      /* end address of SAU region 4 */
...
//     <o>Start Address <0-0xFFFFFFE0>
*/
#define SAU_INIT_START5     (ROMX_BASE + ROM_SIZE)

/*
//     <o>End Address <0x1F-0xFFFFFFFF>
*/
#define SAU_INIT_END5       (ROMX_BASE + ROM_SIZE + ROM_EXT_SIZE)
...
*/
#define NVIC_INIT_ITNS0_VAL      0xFFFEFFFF// PAGESPY_IRQn: Secure state
