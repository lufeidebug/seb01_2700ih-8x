#ifndef __REG_SEC_BEST1503P_H__
#define __REG_SEC_BEST1503P_H__
...
#define SEC_CFG_INIT_VALUE_MPC_SRAM8                    (1 << 8)
#define SEC_CFG_NONSEC_BYPASS_MPC_SRAM8                 (1 << 9)
#define SEC_CFG_INIT_VALUE_MPC_SRAM7                    (1 << 10)
#define SEC_CFG_NONSEC_BYPASS_MPC_SRAM7                 (1 << 11)
#define SEC_CFG_INIT_VALUE_MPC_SRAM6                    (1 << 12)
#define SEC_CFG_NONSEC_BYPASS_MPC_SRAM6                 (1 << 13)
#define SEC_CFG_INIT_VALUE_MPC_SRAM5                    (1 << 14)
#define SEC_CFG_NONSEC_BYPASS_MPC_SRAM5                 (1 << 15)
#define SEC_CFG_INIT_VALUE_MPC_SRAM4                    (1 << 16)
#define SEC_CFG_NONSEC_BYPASS_MPC_SRAM4                 (1 << 17)
#define SEC_CFG_INIT_VALUE_MPC_SRAM3                    (1 << 18)
#define SEC_CFG_NONSEC_BYPASS_MPC_SRAM3                 (1 << 19)
#define SEC_CFG_INIT_VALUE_MPC_SRAM2                    (1 << 20)
#define SEC_CFG_NONSEC_BYPASS_MPC_SRAM2                 (1 << 21)
#define SEC_CFG_INIT_VALUE_MPC_SRAM1                    (1 << 22)
#define SEC_CFG_NONSEC_BYPASS_MPC_SRAM1                 (1 << 23)
#define SEC_CFG_INIT_VALUE_MPC_SRAM0                    (1 << 24)
#define SEC_CFG_NONSEC_BYPASS_MPC_SRAM0                 (1 << 25)
...
#define SEC_IRQ_CLR_PPC_SRAM8                           (1 << 2)
#define SEC_IRQ_EN_PPC_SRAM8                            (1 << 3)
...
#define SEC_IRQ_EN_MPC_C0CC                             (1 << 25)
#define SEC_IRQ_EN_MPC_C0DC                             (1 << 26)
#define SEC_IRQ_EN_MPC_C1CC                             (1 << 27)
#define SEC_IRQ_EN_MPC_C1DC                             (1 << 28)
...
#define SEC_IRQ_MPC_C0CC                                (1 << 14)
#define SEC_IRQ_MPC_C0DC                                (1 << 15)
#define SEC_IRQ_MPC_C1CC                                (1 << 16)
#define SEC_IRQ_MPC_C1DC                                (1 << 17)
