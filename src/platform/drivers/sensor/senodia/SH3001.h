...
#define SH3001_INT_LEVEL_LOW		(0x80)
#define SH3001_INT_LEVEL_HIGH		(0x7F)
...
#define SH3001_INT_INT1_NORMAL	    (0x04)
#define SH3001_INT_INT1_OD			(0xFB)
#define SH3001_INT_INT_NORMAL		(0x01)
#define SH3001_INT_INT_OD			(0xFE)
...
extern void SH3001_INT_Config(	unsigned char intLevel,
