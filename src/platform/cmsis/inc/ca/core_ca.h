...
#define NVIC_GetPendingIRQ(irq)             GIC_GetPendingIRQ(irq)
#define NVIC_GetEnableIRQ(irq)              GIC_GetEnableIRQ(irq)
...
//Page_4k_Normal. Outer & inner non-cacheable, non-shareable, executable, rw, domain 0
