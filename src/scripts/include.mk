...
CMDRMFILERi = cd $(subst /,\,$1) && del /f /q /s $(subst /,\,$2)
...
value_zero = $(if $(filter-out x b -,$(subst 0,$(empty),$1)),n,y)
...
ifeq ($(WIN_PLAT),y)
addtree = $(if $(patsubst -I%,%,$(1)),$(if $(filter-out -I$(KBUILD_ROOT)/%,$(1)),$(patsubst -I%,-I$(srctree)/%,$(1)),$(1)))
else
...
a_flags_func = $(foreach o,$($(1)),$(if \
         $(filter -Wa$(comma)-I%,$(o)),$(subst $(space),$(comma),$(foreach \
         m,$(subst $(comma),$(space),$(o)),$(call flags,m))),$(call flags,o)))
