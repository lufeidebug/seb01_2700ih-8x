...
enum smf_error_e{
	...
	SMF_ERROR_MASK_CHIP						= 0x2000,
	SMF_ERROR_MASK_CPU						= 0x4000,
	SMF_ERROR_MASK_USER						= 0x8000,
	SMF_ERROR_MASK_CHIP_CPU					= 0x6000,
	//
	...
	SMF_ERROR_INVALID_CODEC					= 0x0104,
	SMF_ERROR_INVALID_URL					= 0x0105,
	//
	...
	SMF_ERROR_DEMUX_MEDIA_PARAM_FAIL		= 0x0604,
	//
	...
	//
	SMF_ERROR_SHARE_WRITE_FAIL				= 0x850,
	SMF_ERROR_SHARE_READ_FAIL				= 0x851,
