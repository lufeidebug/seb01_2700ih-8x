...
DrcState *drc_create(int sample_rate, int sample_bit, int ch_num, int max_look_ahead_time, const DrcConfig *config);
...
int32_t drc_get_buffer_size(int sample_rate, int ch_num, int band_num, int max_look_ahead_time);
