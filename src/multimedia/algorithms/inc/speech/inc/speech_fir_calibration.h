...
#define speech_fir_calib_get_delay CONSTRUCT_FUNC_NAME(speech, FIR_CALIB_IMPL, calib_get_delay)
#define speech_fir_calib_get_required_mips CONSTRUCT_FUNC_NAME(speech, FIR_CALIB_IMPL, calib_get_required_mips)
...
int32_t speech_fir_calib_get_delay(SpeechFirCalibState *st);

float speech_fir_calib_get_required_mips(SpeechFirCalibState *st);
