...
{
    FS_TRACE(FFS_DBG, "disk_initialize on drv [%d]\n", drv);
...
{
    FS_TRACE(FFS_DBG, "disk_status on drv [%d]\n", drv);
...
{
    FS_TRACE(FFS_DBG, "disk_read(sector %d, count %d) on drv [%d]\n", sector, count, drv);
...
{
    FS_TRACE(FFS_DBG, "disk_write(sector %d, count %d) on drv [%d]\n", sector, count, drv);
