...
#ifndef __INCLUDE_AOS_DIRENT_H
#define __INCLUDE_AOS_DIRENT_H
 ...
 * Note that because of the simplified filesystem organization of the Aos,
 ...
 * serial number.  This functionality is not implemented in Aos.
 */
