...
#ifndef __INCLUDE_AOS_FS_PARTITION_H
#define __INCLUDE_AOS_FS_PARTITION_H
...
typedef CODE void (*partition_handler_t)(FAR struct partition_s *part, FAR void *arg);
...
#endif /* __INCLUDE_AOS_FS_PARTITION_H */
