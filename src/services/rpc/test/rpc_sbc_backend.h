#ifndef __RPC_SBC_BACKEND_H__
#define __RPC_SBC_BACKEND_H__
...
/*
 * NOTE:
 * header used by rpc implementation, application should not include this header
 */


/*
 * The command name,this must be same with client side
