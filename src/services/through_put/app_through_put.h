...
#define THROUGHPUT_DATA_MAX_SIZE (BT_SPP_MAX_TX_MTU - THROUGHPUT_CMD_PAYLOAD_HEADER_LEN)
typedef struct
{
...
/*---------------------------------------------------------------------------
 *            app_throughput_test_constantly_send_command
 *---------------------------------------------------------------------------
 *
 *Synopsis:
 *    function will constantly send cmd until the cmd fifo is overflow or txCredit is run out.
 *
 * Parameters:
 *    void
 *
