...
#define MAXIMUM_DATA_PACKET_LEN     BT_SPP_MAX_TX_MTU
...
APP_SV_CMD_RET_STATUS_E     app_sv_send_command(APP_SV_CMD_CODE_E cmdCode, uint8_t* ptrParam, uint32_t paramLen, uint8_t device_id);
...
uint32_t app_sv_rcv_cmd(void *param1, uint32_t param2, uint8_t param3);
