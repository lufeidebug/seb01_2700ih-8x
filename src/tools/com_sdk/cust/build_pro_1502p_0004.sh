...
then
        ...
        make T=sensor_hub -j8 DEBUG=1 $DEBUG_LIB_CFG GEN_LIB=1 SENS_TRC_TO_MCU=1 CHIP=$CHIPID VOICE_ASSIST_FF_FIR_LMS=1 MCU_I2C_SLAVE=1 LARGE_SENS_RAM=1 SENS_USE_SENS_MAIN=1 SPEECH_ARMCC_LIB=$SPEECH_ARMCC_LIB APP_MCPP_CLI=SENS APP_MCPP_SRV=bes APP_MCPP_BTH_SENS=1 AUDIO_ANC_FIR_HW=1 FIR_LMS_AEC_ENABLED=$FIR_LMS_AEC_ENABLED CP_IN_SAME_EE=1 SENS_FIR_LMS_SIZE=0x20000 VOICE_ASSIST_FF_FIR_LMS_CP_ACCEL=1 VOICE_ASSIST_FF_FIR_LMS_MULTI_THREAD=0 FREEMAN_ENABLED_STERO=$FREEMAN_ENABLED_STERO
