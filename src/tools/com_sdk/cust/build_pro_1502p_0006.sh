...
USBAUDIO_CFG="BT_USB_AUDIO_DUAL_MODE=1 USB_COMM=1 USB_AUDIO_SEND_CHAN=1 DELAY_STREAM_OPEN=1 USB_AUDIO_DYN_CFG=1 HID_ULL_ENABLE=1 USB_AUDIO_SPEECH=1 AUDIO_LINEIN=1 \
...
BUILD_CUSTOMER_CFG="-j $TYPE_CFG $RES_CFG $COM_CFG $OTA_CFG $ALGO_CFG $ENC_CFG $ADV_CFG $ANC_CFG $PAIR_CFG lst all"
