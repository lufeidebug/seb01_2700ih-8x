...
BES_LIB_DIR="BES_LIB_DIR=lib/bes/best1306p/PRO_0005"
################################### end of var define ###################################

build_app_cmd="make T=$TARGET_LIST $APP_CUSTOMER_CFG $BLE_CFG $OTA_CFG $FREEMAN_CFG $SPEECH_2MIC_CFG $DECODE_DECODER_CFG $SYS_CFG $ROM_CFG $BES_LIB_DIR -j64"
