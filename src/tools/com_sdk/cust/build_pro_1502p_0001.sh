...
TYPE_CFG="BLE_HID_ENABLE=1"
COM_CFG="DEBUG=1 APP_TRACE_RX_ENABLE=1 APP_RX_API_ENABLE=1"
OTA_CFG="BES_OTA=1 OTA_BIN_COMPRESSED=1"
ALGO_CFG="A2DP_VIRTUAL_SURROUND=1 AUDIO_BASS_ENHANCER=1"
ENC_CFG="SPEECH_TX_2MIC_NS8=0"
GFPS_CFG="BLE=1 GFPS_ENABLE=1"
ANC_CFG="ANC_ENABLE=0 ANC_FF_ENABLED=0 ANC_FB_ENABLED=0"
LIB_CFG="BES_LIB_DIR=lib/bes/best1502p/PRO_0001"
PAIR_CFG="POWER_ON_ENTER_TWS_PAIRING_ENABLED=1"
set -e

BUILD_CUSTOMER_CFG="-j $TYPE_CFG $COM_CFG $OTA_CFG $ALGO_CFG $ENC_CFG $GFPS_CFG $ANC_CFG $LIB_CFG $PAIR_CFG"
