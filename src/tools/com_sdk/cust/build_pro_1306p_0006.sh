...
APP_CUSTOMER_CFG="IGNORE_POWER_ON_KEY_DURING_BOOT_UP=1 IS_AUTOPOWEROFF_ENABLED=0 APP_TRACE_RX_ENABLE=1 APP_RX_API_ENABLE=1 AUDIO_DEBUG_CMD=0 \
                 TRACE_BUF_SIZE=20*1024 USE_TRACE_ID=0 CAPSENSOR_ENABLE=1"
...
SYS_CFG=" ALLOW_WARNING=1 RAMCP_SIZE=0x40000 FAST_XRAM_SECTION_SIZE=0x6000 "

ANC_CFG="ANC_ENABLE=1 ANC_ASSIST_ENABLED=0 VOICE_ASSIST_NOISE=1 VOICE_ASSIST_CUSTOM_LEAK_DETECT=0 VOICE_ASSIST_CUSTOM_LEAK_DETECT=0 TOTA_v2=1"

ANC_USB_CFG="USB_AUDIO_APP=1 ULTRA_LOW_POWER=1 PMU_USB_PIN_CHECK=0 OSC_26M_X4_AUD2BB=1 USB_AUDIO_DYN_CFG=0 RTOS=0"

BES_LIB_DIR="BES_LIB_DIR=lib/bes/best1306p/PRO_0006"
################################### end of var define ###################################

build_app_cmd="make T=$TARGET_LIST $APP_CUSTOMER_CFG $BLE_CFG $OTA_CFG $TWS_CFG $SPEECH_2MIC_CFG $DECODE_DECODER_CFG $SYS_CFG $ANC_CFG $ROM_CFG $BES_LIB_DIR -j64"
