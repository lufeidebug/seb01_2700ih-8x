...
AUDIO_CODEC_CFG="A2DP_AAC_ON=1 A2DP_LDAC_ON=0 A2DP_LHDC_ON=0 A2DP_LHDC_V3=0 A2DP_LHDCV5_ON=0 HW_DAC_IIR_EQ_PROCESS=1"
...
COM_CFG="DEBUG=1 APP_TRACE_RX_ENABLE=0 APP_RX_API_ENABLE=0 TRACE_BUF_SIZE=36*1024 AUDIO_DEBUG=0"
...
BT_APP_FEATURE_CFG="SPEECH_NS_BECO=1 SPEECH_TX_1MIC_NS=1 SPEECH_TX_2MIC_NS8=0 SPEECH_TX_3MIC_NS=0 \
					SPEECH_TX_1MIC_PREAF=0 SPEECH_TX_2MIC_PREAF=0 \
					SPEECH_TX_DC_FILTER=1 SPEECH_TX_EQ=1 SPEECH_TX_AEC2FLOAT=1 SPEECH_TX_COMPEXP=1 \
					SPEECH_RX_COMPEXP=1 SPEECH_RX_AGC=1 SPEECH_RX_NS2FLOAT=1 SPEECH_RX_EQ=1 \
					BLE=1 GATT_OVER_BR_EDR=1 BT_SVC_MODULE_TWS_BLE_SEAMLESS_SWITCH=0 BLE_SEEMLESS_ENABLED=0 \
					SPP_EQ_TUNING=1 CTKD_ENABLE=1 IS_CTKD_OVER_BR_EDR_ENABLED=1 SPEECH_TX_AEC_CODEC_REF=1"
