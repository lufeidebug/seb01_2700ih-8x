...
APP_CUSTOMER_CFG="IGNORE_POWER_ON_KEY_DURING_BOOT_UP=1 IS_AUTOPOWEROFF_ENABLED=0 APP_TRACE_RX_ENABLE=1 APP_RX_API_ENABLE=1 AUDIO_DEBUG_CMD=0 \
                 ...
                 CTKD_ENABLE=1 \
                 BESUI_STEREO_EN=1 BESUI_TWS_EN=0 BES_NOTWS_EN=1"
...
DECODE_DECODER_CFG="A2DP_AAC_ON=1 A2DP_LDAC_ON=1 A2DP_LHDC_ON=0 A2DP_LHDC_V3=0 A2DP_LHDCV5_ON=0"
...
BES_LIB_DIR="BES_LIB_DIR=lib/bes/best1502p/PRO_0010"
################################### end of var define ###################################

build_app_cmd="make T=$TARGET_LIST $APP_CUSTOMER_CFG $BLE_CFG $OTA_CFG $FREEMAN_CFG $SPEECH_CFG $DECODE_DECODER_CFG $SYS_CFG $ANC_CFG $ROM_CFG $SPEECH_2MIC_CFG $BES_LIB_DIR $LEA_CFG -j64"
