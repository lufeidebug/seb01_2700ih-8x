...
# ./tools/com_sdk/cust/build_pro_1502p_00011.sh best1502p
################################### var define ###################################
...
SPEECH_2MIC_CFG="SPEECH_TX_DC_FILTER=1 SPEECH_TX_2MIC_NS8=1 SPEECH_TX_2MIC_PREAF=1 SPEECH_RX_NS2FLOAT=1"
...
ANC_CFG="ANC_ENABLE=1 ANC_ASSIST_ENABLED=1 VOICE_ASSIST_NOISE=0 TOTA_v2=1"

BES_LIB_DIR="BES_LIB_DIR=lib/bes/best1502p/PRO_00011"
################################### end of var define ###################################

build_app_cmd="make T=$TARGET_LIST $APP_CUSTOMER_CFG $BLE_CFG $OTA_CFG $FREEMAN_CFG $SPEECH_2MIC_CFG $DECODE_DECODER_CFG $SYS_CFG $ANC_CFG $ROM_CFG $BES_LIB_DIR -j64"
