...
COMMAND=$1
set -e
# build_ota_copy_cmd="make T=prod_test/ota_copy CHIP=best1502p OTA_BIN_COMPRESSED=1 OTA_CODE_OFFSET=0x20000 DEBUG=1 BES_LIB_DIR=lib/bes/best1502p/PRO_0003 -j64"
build_cust_cmd="make T=anc_usb -j CHIP=best1502p USB_AUDIO_UAC2=1 USB_HIGH_SPEED=1 USB_PLUGOUT_DET=1 USB_AUDIO_APP=1 ULTRA_LOW_POWER=1 PMU_USB_PIN_CHECK=0 OSC_26M_X4_AUD2BB=1 USB_AUDIO_DYN_CFG=1 RTOS=1 USB_AUDIO_384K=1 USB_HID_COMMAND_ENABLE=1 BT_SERVICE_ENABLE=0 BES_LIB_DIR=lib/bes/best1502p/PRO_0003 -j64"
