...
BUILD_CUSTOMER_CFG="POWER_ON_ENTER_TWS_PAIRING_ENABLED=1 TRACE_BUF_SIZE=32*1024 \
				BLE=1 GATT_OVER_BR_EDR=1 CTKD_ENABLE=1 IS_CTKD_OVER_BR_EDR_ENABLED=1 BLE_PRF_HID=0 BLE_HID_ENABLE=0 \
				...
				ANC_ASSIST_ENABLED=1 ANC_ENABLE=1 ANC_APP=1 AUDIO_ADAPTIVE_VOLUME=0 \
				...
				FREEMAN_OTA_ENABLE=0 A2DP_VIRTUAL_SURROUND_STEREO=0 AUDIO_LIMITER=1 AUDIO_DRC=0 \
				SPEECH_NS_BECO=1 ANC_FF_ENABLED=1 ANC_FB_ENABLED=1 SWIFT_ENABLE=0"
