...
export SNDP_PMU_MGR                             := 0
export SNDP_CHARGER_PLUG_MGR                    := 0
export SNDP_BATTERY_MGR                         := 0
export SNDP_CHARGER_MGR                         := 0
export SNDP_TEMPERATURE_MGR                     := 0
export SNDP_COVER_SWITCH_MGR                    := 0
export SNDP_IOBOX_MGR                           := 0
export SNDP_WEAR_DETECT_MGR                     := 0
export SNDP_GESTURE_MGR                         := 0
export SNDP_COMMUNICATION_MGR                   := 0
export SNDP_PRODUCT_TEST                        := 0
...
# adc_db[] = { -9, -6, -3, 0, 3, 6, 9, 12, }
    KBUILD_CPPFLAGS += -DANALOG_ADC_A_GAIN_DB=6
    KBUILD_CPPFLAGS += -DANALOG_ADC_B_GAIN_DB=6
