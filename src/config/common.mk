...
export BES_BT_IMPL_INCLUDES = \
    ...
    -I$(BLUETOOTH_SERVICE_DIR_PATH)/audio_policy/bt_focus/inc \
    -I$(BLUETOOTH_STACK_DIR_PATH)/bt_if/inc \
    -I$(BLUETOOTH_STACK_DIR_PATH)/bt_profiles/inc \
...
export GFPS_BR_EDR_SEC_CONN_SWITCH_ENABLED ?= 1
ifeq ($(GFPS_BR_EDR_SEC_CONN_SWITCH_ENABLED),1)
KBUILD_CPPFLAGS += -DGFPS_BR_EDR_SEC_CONN_SWITCH_ENABLED
endif
...
ifneq ($(AUD_IIR_NUM),)
KBUILD_CPPFLAGS += -DAUD_IIR_NUM=$(AUD_IIR_NUM)
endif
...
ifeq ($(SPEECH_OUTPUT_SW_GAIN_BEFORE_ALGO),1)
export AUDIO_OUTPUT_SW_GAIN := 1
export SPEECH_OUTPUT_SW_GAIN_BEFORE_ALGO
endif
...
ifeq ($(USE_MULTI_FLASH),1)
FLASH1_CALIB_SECTION_SIZE ?= $(FLASH_SECTOR_SIZE)
endif

ifneq ($(FLASH1_CALIB_SECTION_SIZE),)
LDS_SECTION_FLAGS += -DFLASH1_CALIB_SECTION_SIZE=$(FLASH1_CALIB_SECTION_SIZE)
KBUILD_CPPFLAGS += -DFLASH1_CALIB_SECTION_SIZE=$(FLASH1_CALIB_SECTION_SIZE)
endif
...
ifeq ($(CHIP),best1307p)
export AUDIO_OUTPUT_DC_CALIB := 0
export AUDIO_OUTPUT_DC_CALIB_ANA := 1
export AUDIO_OUTPUT_ANA_DC_DEEP_CALIB := 1
export AUDIO_OUTPUT_DIG_DC_DEEP_CALIB := 0
export AUDIO_OUTPUT_SET_LARGE_ANA_DC := 0
else
export AUDIO_OUTPUT_DC_CALIB := 1
export AUDIO_OUTPUT_DC_CALIB_ANA := 0
export AUDIO_OUTPUT_ANA_DC_DEEP_CALIB ?= 0
...
ifeq ($(CHIP),best1307p)
export AUDIO_ADC_ANA_DC_CALIB ?= 0
export AUDIO_ADC_DIG_DC_CALIB ?= 1
else
export AUDIO_ADC_ANA_DC_CALIB ?= 1
...
ifeq ($(AUDIO_ADC_ANA_DC_CALIB), 1)
KBUILD_CPPFLAGS += -DAUDIO_ADC_ANA_DC_CALIB
endif
