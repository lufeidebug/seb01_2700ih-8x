...
BLE := 1
export FAST_XRAM_SECTION_SIZE ?= 0x12000
...
export TOTA_v2 ?= 1
ifeq ($(TOTA_v2),1)
export OTA_OVER_TOTA_ENABLED ?= 1
export IS_BLE_TOTA_ENABLED ?= 1
export IS_BLE_RX_HANDLER_THREAD_ENABLED ?= 1
export DATA_DUMP_TOTA ?= 0
export STREAM_DATA_OVER_TOTA ?= 0
endif

export IS_BLE_ACTIVITY_COUNT_MORE_THAN_THREE ?= 1
